...
# New Update 2022 May 3 - JB to create a separate file for gloeo data from each site
...
# Add month and ln of gloeo column ####
dat3 <- dat2 %>%
...
write_csv(sotf_gloeo_data, "./00_Data_files/Covariate_analysis_data/SOTF_Gechinulata_long.csv")
write_csv(nsh_gloeo_data, "./00_Data_files/Covariate_analysis_data/NSH_Gechinulata_long.csv")

# # Write sampling dates as a csv - 2 files 1 difference in dates:
# HC/SOTF same sample dates 2010-09-23
# NB/NSH same sample dates - 2010-09-22
# only needs done once, as this file will stay in repo

# HC/SOTF sample dates
...
# NB/NSH sample dates
# sampling_dates_NB <- tibble(nb_gloeo_data$date)
# colnames(sampling_dates_NB) <- "date"
# write_csv(sampling_dates_NB, "./00_Data_files/sampling_dates_NB.csv")
