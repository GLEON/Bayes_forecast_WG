...
model_names <- c("RW","RW_obs","AR","wtrtemp_min","wtrtemp_min_lag","wtrtemp_MA7","schmidt_med_diff","wnd_dir_2day_lag","GDD","schmidt_and_temp","schmidt_max_lag","precip","precip_and_GDD","schmidt_and_precip","temp_and_precip")
yrs <- c(2015:2016)
wks <- c(1:20)
