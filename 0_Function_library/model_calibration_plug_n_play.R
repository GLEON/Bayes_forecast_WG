...
#RW
  data.RW <- list(y=y, year_no = year_no,season_weeks=season_weeks,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.001, r_obs = 0.001)
...
#RW_obs
  data.RW_obs <- list(y=y, year_no = year_no,season_weeks=season_weeks,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 15.37, r_obs = 7.84)
...
#AR
  data.AR <- list(y=y, year_no = year_no,beta.m1=0,  beta.m2=0,beta.v1=0.001, beta.v2=0.001,  season_weeks=season_weeks,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 15.37, r_obs = 7.84)
