...
# #Linear_1var
#   data.Linear_1var <- list(y=hindcast_data$y, year_no = hindcast_data$year_no, season_weeks=hindcast_data$season_weeks,Temp=hindcast_data$Temp, week_avg=hindcast_data$week_avg, beta.m1=0,  beta.m2=0,beta.m3=0, beta.v1=0.001, beta.v2=0.001,beta.v3=0.001, x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 15.37, r_obs = 7.84)
#   variable.names.Linear_1var <- c("tau_proc", "beta1","beta2", "beta3", "tau_obs","tau_T_proc")
#   variable.namesout.Linear_1var <- c("tau_proc", "beta1", "beta2","beta3",  "mu", "tau_obs", "tau_T_proc")
#   init.Linear_1var <- list(list(tau_proc=0.001, tau_obs = 0.1,  tau_T_proc = 0.01, beta1=-0.5, beta2=-0.5, beta3=-0.5), list(tau_proc=0.1,  tau_obs = 1,tau_T_proc = 0.1, beta1=0, beta2=0, beta3=0), list(tau_proc=1, tau_obs = 5,tau_T_proc = 1, beta1=0.5,beta2=0.5, beta3=0.5))
#   params.Linear_1var <- c("tau_proc","beta1", "beta2", "beta3","tau_obs","tau_T_proc")
#
# #Quad_1var
#   data.Quad_1var <- list(y=hindcast_data$y, year_no = hindcast_data$year_no, season_weeks=hindcast_data$season_weeks,Schmidt=hindcast_data$Schmidt, week_avg=hindcast_data$week_avg, beta.m1=0,  beta.m2=0,beta.m3=0,beta.m4=0,beta.v1=0.001, beta.v2=0.001,beta.v3=0.001,beta.v4=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 15.37, r_obs = 7.84)
#   variable.names.Quad_1var <- c("tau_proc", "beta1","beta2", "beta3","beta4", "tau_obs","tau_S_proc")
#   variable.namesout.Quad_1var <- c("tau_proc", "beta1", "beta2","beta3","beta4",  "mu", "tau_obs", "tau_S_proc")
#   init.Quad_1var <- list(list(tau_proc=0.001, tau_obs = 0.1,  tau_S_proc = 0.01, beta1=-0.5, beta2=-0.5, beta3=-0.5, beta4=-0.5), list(tau_proc=0.1,  tau_obs = 1,tau_S_proc = 0.1, beta1=0, beta2=0, beta3=0, beta4=0), list(tau_proc=1, tau_obs = 5,tau_S_proc = 1, beta1=0.5,beta2=0.5, beta3=0.5, beta4=0.5))
#   params.Quad_1var <- c("tau_proc","beta1", "beta2", "beta3","beta4","tau_obs","tau_S_proc")
#
# #Linear_2var
#   data.Linear_2var <- list(y=hindcast_data$y, year_no = hindcast_data$year_no, season_weeks=hindcast_data$season_weeks,Temp=hindcast_data$Temp, Schmidt=hindcast_data$Schmidt, week_avg_T=hindcast_data$week_avg_T,week_avg_S=hindcast_data$week_avg_S, beta.m1=0,  beta.m2=0,beta.m3=0,beta.m4=0, beta.v1=0.001, beta.v2=0.001,beta.v3=0.001,beta.v4=0.001, x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 15.37, r_obs = 7.84)
...
#
# #Quad_2var
#   data.Quad_2var <- list(y=hindcast_data$y, year_no = hindcast_data$year_no, season_weeks=hindcast_data$season_weeks,Temp=hindcast_data$Temp, Schmidt=hindcast_data$Schmidt, week_avg_T=hindcast_data$week_avg_T,week_avg_S=hindcast_data$week_avg_S, beta.m1=0,  beta.m2=0,beta.m3=0,beta.m4=0,beta.m5=0, beta.v1=0.001, beta.v2=0.001,beta.v3=0.001,beta.v4=0.001,beta.v5=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 15.37, r_obs = 7.84)
