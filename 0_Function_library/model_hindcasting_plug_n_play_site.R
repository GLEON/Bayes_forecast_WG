# Title: Plug and play scripts to set conditions for model hindcasting runs
# History:
...
# updates 3 Aug for air temp GDD and variable names out to include covars for driver hindcasts
...
# RW_obs_1site
  data.RW_obs_1site <- list(y=hindcast_data$y, season_weeks=hindcast_data$season_weeks,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)
...
# DLM_1site
  data.DLM_1site <- list(y=hindcast_data$y, season_weeks=hindcast_data$season_weeks, beta.m1=0,  beta.m2=0,beta.v1=0.001, beta.v2=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)
...
### Quad_2var_RY - Quad 2 variable with Random Year effect
  ...
  data.Quad_2var_RY <- list(y=hindcast_data$y, season_weeks = hindcast_data$season_weeks, year_no = hindcast_data$year_no, totYr = hindcast_data$totYr, covar1=hindcast_data$covar1, covar2=hindcast_data$covar2, week_avg1=hindcast_data$week_avg1,week_avg2=hindcast_data$week_avg2, beta.m1=0,  beta.m2=0,beta.m3=0,beta.m4=0,beta.m5=0, beta.v1=0.001, beta.v2=0.001,beta.v3=0.001,beta.v4=0.001,beta.v5=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)

  variable.names.Quad_2var_RY <- c("tau_yr","yr", "tau_proc", "beta1","beta2", "beta3","beta4","beta5", "tau_obs","tau_C1_proc", "tau_C2_proc")

  variable.namesout.Quad_2var_RY <- c("tau_yr","yr", "tau_proc", "beta1", "beta2","beta3","beta4","beta5",  "mu", "tau_obs", "tau_C1_proc", "tau_C2_proc","covar1","covar2")
...
### Quad_2var_RY_airtemp - Quad 2 variable with Random Year effect & GDD with air temp for each site
  ...
  variable.namesout.Quad_2var_RY_airtemp <- c("tau_yr","yr", "tau_proc", "beta1", "beta2","beta3","beta4","beta5",  "mu", "tau_obs", "tau_C1_proc", "covar1","covar2")
...
# RW_obs_3sites
  data.RW_obs_3sites <- list(y=hindcast_data$y, season_weeks=hindcast_data$season_weeks, site_no = hindcast_data$site_no, x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)
  ...
  # DLM_3sites
  data.DLM_3sites <- list(y=hindcast_data$y, season_weeks=hindcast_data$season_weeks, site_no = hindcast_data$site_no, beta.m1=0,  beta.m2=0,beta.v1=0.001, beta.v2=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)
  ...
  data.Quad_2var_multisite <- list(y=hindcast_data$y, season_weeks=hindcast_data$season_weeks, site_no = hindcast_data$site_no, covar1=hindcast_data$covar1, covar2=hindcast_data$covar2, week_avg1=hindcast_data$week_avg1,week_avg2=hindcast_data$week_avg2, beta.m1=0,  beta.m2=0,beta.m3=0,beta.m4=0,beta.m5=0, beta.v1=0.001, beta.v2=0.001,beta.v3=0.001,beta.v4=0.001,beta.v5=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)
  ...
  data.Quad_2var_multisite_RY <- list(y=hindcast_data$y,season_weeks=hindcast_data$season_weeks, site_no = hindcast_data$site_no, year_no = hindcast_data$year_no, totYr = hindcast_data$totYr, covar1=hindcast_data$covar1, covar2=hindcast_data$covar2, week_avg1=hindcast_data$week_avg1,week_avg2=hindcast_data$week_avg2, beta.m1=0,  beta.m2=0,beta.m3=0,beta.m4=0,beta.m5=0, beta.v1=0.001, beta.v2=0.001,beta.v3=0.001,beta.v4=0.001,beta.v5=0.001,x_ic=-5,tau_ic = 100,a_proc = 0.001,r_proc = 0.001, a_obs = 0.555, r_obs = 0.349)
