...
run_hindcast <- function(model_name, params, Nmc, IC, wk, covar_hindcast){
  ...
  if(!model_name %in% c("RW_obs","RW_bias","AC","base_DLM","wtrtemp_min","wtrtemp_min_lag","wtrtemp_MA7","GDD","wnd_dir_2day_lag","schmidt_max_lag","schmidt_and_wind","temp_and_wind","wind_and_GDD")){
