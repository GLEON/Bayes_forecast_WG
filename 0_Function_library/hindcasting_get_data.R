...
if (model_name == "schmidt_and_wnd"){
  ...
  #read in covar2 data
  covar02 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/wnd_dir_2day_lag.csv"))
  #read in prior2 data
  prior2 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/wnd_dir_2day_lag.csv"))
...
if (model_name == "schmidt_diff_and_max"){
  ...
  #read in covar2 data
  covar02 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/schmidt_max_lag.csv"))
  #read in prior2 data
  prior2 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/schmidt_max_lag.csv"))
}
if (model_name == "wnd_dir_and_speed"){
  #read in covar1 data
  covar01 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/wnd_dir_2day_lag.csv"))
  #read in prior1 data
  prior1 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/wnd_dir_2day_lag.csv"))

  #read in covar2 data
  covar02 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/wnd_sp_mean_3daylag.csv"))
  #read in prior2 data
  prior2 <- as.matrix(read_csv("./00_Data_files/Bayesian_model_input_data/wnd_sp_mean_3daylag.csv"))
}
...
#subset covar data depending on year and season_week
if(model_name %in% c("schmidt_and_wnd","wnd_dir_and_speed","schmidt_diff_and_max")){
  if(year == 2015){
